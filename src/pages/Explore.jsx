// Created at (11:50): https://youtu.be/YehktV6LSqw?si=gFuDeGQov8P9eTZ8&t=710
// Built out (20:05): https://youtu.be/YehktV6LSqw?si=7DNr4mBHqXutXWs9&t=1205
                ...
                <div className='flex flex-col items-center mb-12'>
                    <div className='mb-16 text-white text-center'>
                        <h1 className='text-5xl  font-bold font-body mb-2'>
                            Acme Health NFT Explorer
                        </h1>
                        <p>A tool to find NFT Prescriptions by owner and contract address</p>
                    </div>
